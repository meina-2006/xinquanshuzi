import sys
content = """import HeartChart from '../components/HeartChart';
  ...
  return (
    <div>
      ...
      <div className="card-grid">
        {card('\u8d77\u59cb\u6570\u5b57', d.start)}
        {card('\u4e3b\u6027\u683c', d.s3)}
        {card('\u5750\u9547\u8054\u5408\u6570\u5b57', \x60$]{d.s1}$]{d.s2}$]{d.s3}\x60)}
        {card('\u5c5e\u76f8', d.zodiac)}
      </div>
...
"""
open('F:/codex/设计心泉数字心理学app/xinquan-app/src/tabs/CalcTab.jsx','w',encoding='utf-8').write(content.encode('utf-8').decode('unicode_escape').replace('$]','\\\\$'))
print('done')
